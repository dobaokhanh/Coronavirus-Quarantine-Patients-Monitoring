...
public class User {
	...
	public User(@NotBlank @Size(max = 40) String name, @NotBlank @Size(max = 20) String username,
			@NotBlank @Size(max = 40) @Email String email, @NotBlank String password) {
		super();
		this.name = name;
	...
	public User(Long id, @NotBlank @Size(max = 40) String name, @NotBlank @Size(max = 20) String username,
			@NotBlank @Size(max = 40) @Email String email, @NotBlank String password, Set<Role> roles) {
		super();
		this.id = id;
		this.name = name;
		this.username = username;
